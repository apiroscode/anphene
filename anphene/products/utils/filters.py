...
from django_filters import FilterSet, MultipleChoiceFilter, OrderingFilter, RangeFilter

from ..models import Product
from ...attributes.models import Attribute

SORT_BY_FIELDS = OrderedDict(
    [("name", "name"), ("minimal_variant_price_amount", "price"), ("updated_at", "last updated"),]
)
...
class ProductFilter(SortedFilterSet):
    ...
    minimal_variant_price = RangeFilter(label="Price", field_name="minimal_variant_price_amount",)
    ...
    def _get_attributes(self):
        ...
        attributes = sorted(attributes, key=lambda attr: attr.storefront_search_position)
        return attributes
    ...
    def _get_attribute_choices(self, attribute):
        return [(choice.pk, choice.translated.name) for choice in attribute.values.all()]
