...
def update_products_minimal_variant_prices(products, discounts=None):
    ...
    for product in products:
        ...
        updated_product = update_product_minimal_variant_price(product, discounts, save=False)
    ...
    Product.objects.bulk_update(changed_products_to_update, ["minimal_variant_price_amount"])
