    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    django.contrib.postgres.fields.citext.CICharField(max_length=250, unique=True),
                ),
                ...
                (
                    ...
                    versatileimagefield.fields.VersatileImageField(
                        ...
                        upload_to=core.utils.images.UploadToPathAndRename(
                            field="name", path="collection-backgrounds"
                        ),
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={"unique_together": {("collection", "product")},},
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="collections.CollectionProduct",
                to="products.Product",
            ),
        ),
    ]
